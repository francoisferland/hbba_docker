...
docker run --net host -e ROS_HOSTNAME=$ROS_HOSTNAME -e ROS_MASTER_URI=$ROS_MASTER_URI francoisferland/hbba:iwo_addons roslaunch hbba_synth base_nodes_r2.launch
